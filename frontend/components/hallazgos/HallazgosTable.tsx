...
export function HallazgosTable({ hallazgos, loading, meta, page, setPage, onSelect }: HallazgosTableProps) {
          ...
          <TableBody>
            {hallazgos.map((h) => (
              <TableRow key={h.id} className="group hover:bg-muted/30 transition-colors">
                ...
                <TableCell className="whitespace-nowrap"><StatusBadge value={h.estado} /></TableCell>
                <TableCell className="whitespace-nowrap text-muted-foreground text-xs">{formatDate(h.fecha_inicial_evento)}</TableCell>
                <TableCell className="whitespace-nowrap text-muted-foreground text-xs">{formatDate(h.fecha_cierre_proyectada)}</TableCell>
                <TableCell>
                  <Button
