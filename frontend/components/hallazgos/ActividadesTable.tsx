...
export function ActividadesTable({ actividades, loading, meta, page, setPage, onSelect }: ActividadesTableProps) {
          ...
          <TableBody>
            {actividades.map((a) => (
              <TableRow key={a.id} className="group hover:bg-muted/30 transition-colors">
                ...
                <TableCell className="whitespace-nowrap text-muted-foreground text-xs">{formatDate(a.fecha_compromiso)}</TableCell>
                <TableCell>
                  <Button
