...
export function TopRetrasadosCard({ data }: Props) {
      ...
      <CardHeader className="pb-2">
        <div className="flex items-center justify-between">
          <div>
            ...
            <CardDescription className="text-xs">Días de retraso · responsable asignado</CardDescription>
          </div>
                ...
                <div key={row.codigo} className="space-y-1">
                  <div className="flex items-center justify-between gap-3 text-xs">
                    ...
                    <div className="flex items-center gap-3 shrink-0">
                      ...
                      {row.responsable && (
                        <span className="text-muted-foreground tabular-nums whitespace-nowrap">{row.responsable}</span>
                      )}
                    </div>
                  </div>
